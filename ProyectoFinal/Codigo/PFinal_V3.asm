...
ComprobarContrasena
	...
	MOVLW ContrasenaIngresada1			; Si tiene el valor igual a la contraseña original
	SUBWF Contrasena1,W					; Resta de comprobacion
	BTFSC STATUS, Z						; Si no cumple con la condicion
	GOTO PrintContrasenaIncorrecta		; Manda el mensaje de contraseña ingresada incorrecta

	MOVLW ContrasenaIngresada2			; Si tiene el valor igual a la contraseña original
	SUBWF Contrasena2,W					; Resta de comprobacion
	BTFSC STATUS, C						; Si no cumple con la condicion
	GOTO PrintContrasenaIncorrecta		; Manda el mensaje de contraseña ingresada incorrecta

	MOVLW ContrasenaIngresada3			; Si tiene el valor igual a la contraseña original
	SUBWF Contrasena3,W					; Resta de comprobacion
	BTFSC STATUS, C						; Si no cumple con la condicion
	GOTO PrintContrasenaIncorrecta		; Manda el mensaje de contraseña ingresada incorrecta

	MOVLW ContrasenaIngresada4			; Si tiene el valor igual a la contraseña original
	SUBWF Contrasena4,W					; Resta de comprobacion
	BTFSC STATUS, C						; Si no cumple con la condicion
	GOTO PrintContrasenaIncorrecta		; Manda el mensaje de contraseña ingresada incorrecta

	MOVLW ContrasenaIngresada5			; Si tiene el valor igual a la contraseña original
	SUBWF Contrasena5,W					; Resta de comprobacion
	BTFSC STATUS, C						; Si no cumple con la condicion
	GOTO PrintContrasenaIncorrecta		; Manda el mensaje de contraseña ingresada incorrecta

	MOVLW ContrasenaIngresada6			; Si tiene el valor igual a la contraseña original
	SUBWF Contrasena6,W					; Resta de comprobacion
	BTFSC STATUS, C						; Si no cumple con la condicion
	GOTO PrintContrasenaIncorrecta		; Manda el mensaje de contraseña ingresada incorrecta

	MOVLW ContrasenaIngresada7			; Si tiene el valor igual a la contraseña original
	SUBWF Contrasena7,W					; Resta de comprobacion
	BTFSC STATUS, C						; Si no cumple con la condicion
	GOTO PrintContrasenaIncorrecta		; Manda el mensaje de contraseña ingresada incorrecta

	MOVLW ContrasenaIngresada8			; Si tiene el valor igual a la contraseña original
	SUBWF Contrasena8,W					; Resta de comprobacion
	BTFSC STATUS, C						; Si no cumple con la condicion
	GOTO PrintContrasenaIncorrecta		; Manda el mensaje de contraseña ingresada incorrecta
		
	GOTO PrintAbierto					; Si todas las contraseñas son correctas manda el mensaje de abierto
