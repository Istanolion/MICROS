...
automatico:
	...
	CALL MandarNiveles		; Imprime el nivel en terminal
VolverDeTerminal
...
ImprimirSimbolos
	...
	MOVLW D'255'				;  Si tiene el valor igual a  255
	SUBWF RegAux,W				;  Resta de comprobacion
	...
	MOVLW D'224'				;  Si tiene el valor igual o mayor a  224
	SUBWF RegAux,W				;  Resta de comprobacion
	BTFSC STATUS, C				;  Si cumple con la condicion
	GOTO PrintOcho				;  Imprime el simbolo correspondiente

	MOVLW D'192'				;  Si tiene el valor igual o mayor a  192
	SUBWF RegAux,W				;  Resta de comprobacion
	BTFSC STATUS, C				;  Si cumple con la condicion
	GOTO PrintSiete				;  Imprime el simbolo correspondiente

	MOVLW D'160'				;  Si tiene el valor igual o mayor a  160
	SUBWF RegAux,W				;  Resta de comprobacion
	BTFSC STATUS, C				;  Si cumple con la condicion
	GOTO PrintSeis				;  Imprime el simbolo correspondiente

	MOVLW D'128'				;  Si tiene el valor igual o mayor a  128
	SUBWF RegAux,W				;  Resta de comprobacion
	BTFSC STATUS, C				;  Si cumple con la condicion
	GOTO PrintCinco				;  Imprime el simbolo correspondiente

	MOVLW D'96'					;  Si tiene el valor igual o mayor a  96
	SUBWF RegAux,W				;  Resta de comprobacion
	BTFSC STATUS, C				;  Si cumple con la condicion
	GOTO PrintCuatro			;  Imprime el simbolo correspondiente

	MOVLW D'64'					;  Si tiene el valor igual o mayor a  64
	SUBWF RegAux,W				;  Resta de comprobacion
	BTFSC STATUS, C				;  Si cumple con la condicion
	GOTO PrintTres				;  Imprime el simbolo correspondiente

	MOVLW D'32'					; Si tiene el valor igual o mayor a  32
	SUBWF RegAux,W				; Resta de comprobacion
	BTFSC STATUS, C				; Si cumple con la condicion
	GOTO PrintDos				; Imprime el simbolo correspondiente
								
	GOTO PrintUno				; Imprimira que esta en el primer nivel si no es algun caso anterior
...
MandarNiveles
	...
	SUBWF RegAux,W				; Resta de comprobacion
	BTFSC STATUS, Z				; Si cumple con la condicion
	GOTO MandaCero				; Manda el simbolo correspondiente

	MOVLW D'255'				;  Si tiene el valor igual a  255
	SUBWF RegAux,W				;  Resta de comprobacion
	BTFSC STATUS, C				;  Si cumple con la condicion
	GOTO MandaCien				;  Manda el simbolo correspondiente

	MOVLW D'224'				;  Si tiene el valor igual o menor a  224
	SUBWF RegAux,W				;  Resta de comprobacion
	BTFSC STATUS, C				;  Si cumple con la condicion
	GOTO MandaOcho				;  Manda el simbolo correspondiente

	MOVLW D'192'				;  Si tiene el valor igual o menor a  192
	SUBWF RegAux,W				;  Resta de comprobacion
	BTFSC STATUS, C				;  Si cumple con la condicion
	GOTO MandaSiete				;  Manda el simbolo correspondiente

	MOVLW D'160'				;  Si tiene el valor igual o menor a  160
	SUBWF RegAux,W				;  Resta de comprobacion
	BTFSC STATUS, C				;  Si cumple con la condicion
	GOTO MandaSeis				;  Manda el simbolo correspondiente

	MOVLW D'128'				;  Si tiene el valor igual o menor a  128
	SUBWF RegAux,W				;  Resta de comprobacion
	BTFSC STATUS, C				;  Si cumple con la condicion
	GOTO MandaCinco				;  Manda el simbolo correspondiente

	MOVLW D'96'					;  Si tiene el valor igual o menor a  96
	SUBWF RegAux,W				;  Resta de comprobacion
	BTFSC STATUS, C				;  Si cumple con la condicion
	GOTO MandaCuatro			;  Manda el simbolo correspondiente


	MOVLW D'64'					;  Si tiene el valor igual o menor a  64
	SUBWF RegAux,W				;  Resta de comprobacion
	BTFSC STATUS, C				;  Si cumple con la condicion
	GOTO MandaTres				;  Manda el simbolo correspondiente

	MOVLW D'32'					; Si tiene el valor igual o menor a  32
	SUBWF RegAux,W				; Resta de comprobacion
	BTFSC STATUS, C				; Si cumple con la condicion
	GOTO MandaDos				; Manda el simbolo correspondiente
								
	GOTO MandaUno				; Mandara que esta en el primer nivel siempre que no sea 0% o 100%

				
	GOTO VolverDeTerminal			; Si no es ningun caso, regresa al inicio
